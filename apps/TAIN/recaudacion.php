    ...
    <div class="container-main">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
              <div class="panel-card">
                <div class="panel-header">
                  ...
                  <span class="panel-badge"><i class="fa-solid fa-person-circle-minus"></i> valid + grat</span>
                </div>
                <div class="panel-body">
            ...
            <div class="panel-card">
                ...
                <a 
                    href="http://10.10.31.207:8086/script/mapa_de_calor/recaudo.html" 
                    target="_blank"
                    class="mapa-calor-link"
                >
                    <img 
                    src="script/mapa_de_calor/scripts/mapa.png" 
                    alt="Mapa de Calor"
