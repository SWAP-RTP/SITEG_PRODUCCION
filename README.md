...
3. Una vez que clones tu repositorio debes construir y levantar tu contenedor, con el comando docker compose up --build, y una ves que este levantado en cada carpeta (login,SWAP,TAIN) debes ejecutar los siguientes comandos para instalar la libreria de firebase                # Para el sistema de Login
